  ...
  return (
    ...
    <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
      <div className="animate__animated animate__fadeInUp animate__delay-3s">
        ...
        <h1 className="text-5xl/tight font-bold mb-6">Hi, Saya Muhammad Fathir</h1>
        <p className="text-base/loose mb-6 opacity-50">Saya mempunyai ketertarikan dalam bidang Programming dan Tari, terutama pada
          pembuatan Website dan Tari seperti poster, Pamflet serta Banner, ketertarikan pada
          bidang ini sudah berlangsung lebih dari 2 tahun untuk bidang Programming dan 6 Tahun untuk
          Tari.
        </p>
      </div>
      <div className="flex items-center sm:gap-4 gap-2">
        ...
        <a href="#talent" className="bg-zinc-700 p-4 rounded-2xl hover:bg-zinc-600">
          Lihat Talent<i className="ri-arrow-down-line ri-lg"></i>
        </a>
      </div>
      ...
      sm:hidden"loading="lazy"/>
        <p className="text-base/loose mb-10">
          Hi, Saya Muhammad Fathir Al Fathsyah, Seorang Full Stack Web Daveloper dan Designer
          untuk UI/UX Design maupun Product Digital, Saya percaya bahwa Desain dan
          fungsionalitas harus jalan beriringan, Sehingga setiap proyek yang Saya
      ...
      <div className="proyek mt-32 py-10" id="talent"> 
            <h1 className="text-center text-4xl font-bold mb-2">Talent</h1>
            <p className="text-base/loose text-center opacity-50" data-aos="fade-up"
            data-aos-duration="1000" data-aos-delay="300">Berikut ini beberapa Talenta atau kegiatan
            yang saya lakukan</p>
                ...
                <div>
                  ...
                  <div>
                    <div className="m5-8 text-center">
                      ...
                      border-zinc-600 hover:bg-violet-600">Lihat Galeri</a>
                    </div>
                  </div>
                </div>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
             ...
             <div className="text-center">
              <button type="submit" className="bg-violet-700 p-3 rounded-lg block border
